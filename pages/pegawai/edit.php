...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-md mx-auto bg-gray-100 shadow-md rounded px-8 pt-6 pb-8 mb-4">
        <h2 class="text-2xl font-bold mb-6 text-center text-green-600">Edit Pegawai</h2>
        ...
        <form action="../../proses/pegawai/edit.php" method="POST" class="space-y-4">
            ...
            <div>
                <label for="nip" class="block text-green-700 text-sm font-bold mb-2">NIP</label>
                <input 
                    type="text" 
                    id="nip" 
                    name="nip" 
            ...
            <div>
                <label for="nama" class="block text-green-700 text-sm font-bold mb-2">Nama Lengkap</label>
                <input 
                    type="text" 
                    id="nama" 
                    name="nama" 
            ...
            <div>
                <label for="jenis_kelamin" class="block text-green-700 text-sm font-bold mb-2">Jenis Kelamin</label>
                <select 
                    id="jenis_kelamin" 
                    name="jenis_kelamin" 
                    required 
            ...
            <div>
                <label for="gaji" class="block text-green-700 text-sm font-bold mb-2">Gaji</label>
                <input 
                    type="text" 
                    id="gaji" 
                    name="gaji" 
